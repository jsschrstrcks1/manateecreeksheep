...
function updateActiveFlock(ss) {
  ...
  var data = [
    ...
    ['Pen 3','1','Orange Tag Ram','orange-tag-00110','00110','ram','287.5','Cracker/Suffolk/GCN/Katahdin','12.5','87.5','wool','wool','','','','Tag 00110, orange tag. Ram. Poop trimmed at butt 2-19-2026. '],
    ['Pen 3','1','Azure','azure','20','ewe','212.5','Hampshire/Suffolk','0','100','','wool','','','YES','Mom calls her Amure. GGs full sister. On weak resistance lis'],
    ['Pen 3','1','Baby Azure','baby-azure','','ewe','','[UNCLEAR - Azure offspring]','','','','','','azure','','No tag (now tagged, number TBD). Born 1-10-26. Azures baby, '],
    ['Pen 3','1','Bambii','bambii','','ewe','','','','','','','','','','In Pen 2 (Sir Loin group) per spiral notebook (authoritative'],
    ['Pen 3','1','Charlies Ewe','charlies-ewe','','ewe','','[UNCLEAR]','','','','','','','','No tag (now tagged, number TBD). Single baby (ram, born 12-2'],
    ...
    ['Pen 3','1','Fawn Wool Ewe (Pen 5)','fawn-wool-ewe-p5','','ewe','','Wool','','','','','','','','No tag (now tagged TBD). Wool ewe, fawn color, long ears. Pe'],
    ['Pen 3','1','GG','gg','23','ewe','212.5','Hampshire/Suffolk','0','100','','wool','','','YES','Azures full brother. On weak resistance list. From Google Sh'],
    ['Pen 3','1','Nuba','nuba-0053','0053','ewe','175','Hampshire/St Augustine/Katahdin','50.0','50','','mixed','samson','','','Tag 0053. White Hair ewe. Name: Nuba (notebook spelling). No'],
    ['Pen 3','1','Wool Ewe 0044','tag-0044-wool-ewe','0044','ewe','170','Katahdin/Awassi/East Friesian','50','50','','mixed','','','','Tag 0044. Wool ewe. No babies. Source: notebook card, pen 1.'],
    ...
    ['Pen 4','3','Rocky','rocky','140','ram','300','Black Headed Dorper/Awassi/East Friesian','50','50','','mixed','teaser','dorper-ewe-198','YES','Also called Jerkface/Rock/Louises Ram. Tag 140. 44%Awassi/50'],
    ['Pen 4','3','0035 Baby Ewe','tag-0035-baby-ewe','','ewe','','','','','','','','tag-0035-white-ewe','','Born 1-2-26. 0035s baby ewe. 7 weeks old 2-20-26. Source: no'],
    ['Pen 4','3','BHD Ewe G023','g023-bhd-ewe','G023','ewe','128.0','Black Headed Dorper','100','0','','hair','','','','Tag G023. BHD ewe. No babies. FAMACHA borderline (3) on 2-20'],
    ['Pen 4','3','Bambiis Baby','bambii-baby','','ewe','','','','','','','','bambii','','Born 12-28-25. Bambiis baby. 7.5 weeks old 2-20-26. Sex UNCL'],
    ['Pen 4','3','Broken Tail Twin Ewe','broken-tail-twin-ewe','','ewe','','[UNCLEAR - Broken Tail offspring]','','','','','','broken-tail','','No tag (now tagged TBD). Born 12-31-25. Broken Tails twin ew'],
    ['Pen 4','3','Broken Tail Twin Ewe 2 (White)','broken-tail-twin-ewe-2','','ewe','','[UNCLEAR - Broken Tail offspring]','','','','','','broken-tail','','No tag (now tagged TBD). Born 12-31-25. Broken Tails second '],
    ['Pen 4','3','Gigis 2026 Baby','gigi-2026-baby','','ewe','','[Kelsier x Gigi offspring]','','','','','kelsier','gg','','Born 1-10-26. Gigis baby. Multi color ewe. Sire: Kelsier. 5.'],
    ...
    ['Pen 4','3','Small White Ewe (Pen 4)','sm-white-ewe-p4','','ewe','145','St Augustine/Katahdin/BBB','100.0','0','','hair','dodge','daisy','','No tag (now tagged TBD). Small white ewe. No babies. Eyes go'],
    ...
    ['Pen 5','4','Buck','buck','','ram','270.8','Katahdin/Awassi/East Friesian','50','50','','mixed','','','','Current Buck in chicken coop. Brother of original Buck who d'],
    ['Pen 5','4','Charlies Farm Ewe Baby','charlies-farm-ewe-baby-p3','','ewe','','[UNCLEAR - Charlies Farm Ewe offspring]','','','','','charlie-ram','charlies-farm-ewe-p3','','No tag (now tagged TBD). Born 12-6-25. Baby ewe from Charlie'],
    ['Pen 5','4','Elsie Large White Ewe Triplet','elsie-triplet-lg-white-ewe','','ewe','','','','','','','eclipse','elsie','','Born 1-6-26. Elsies triplet. Large white female. Sire: Eclip'],
    ['Pen 5','4','Elsie Small White Ewe Triplet','elsie-triplet-sm-white-ewe','','ewe','','','','','','','eclipse','elsie','','Born 1-6-26. Elsies triplet. Small white female. Sire: Eclip'],
    ['Pen 5','4','Noris Baby (Pen 3)','nori-baby-p3','','ewe','','[UNCLEAR - Nori offspring]','','','','','','nori','','No tag (now tagged TBD). Born 1-10-26. 0029/Noris Baby. 5.3 '],
    ['Pen 5','4','Serendipity Black Ewe Twin','serendipity-twin-ewe','','ewe','','[Kelsier x Serendipity offspring]','','','','','kelsier','serendipity','','Born 12-30-25. Serendipitys black ewe twin. Sire: Kelsier. F'],
    ['Pen 6','5','Serendipity White Ram Twin','serendipity-twin-ram','','ram','','[Kelsier x Serendipity offspring]','','','','','kelsier','serendipity','','Born 12-30-25. Serendipitys white ram twin. Sire: Kelsier. F'],
    ['Pen 6','5','Charlies Farm Ewe (Pen 3)','charlies-farm-ewe-p3','','ewe','155','Katahdin/BHD/ABB/Wiltshire Horn','100.0','0','','hair','','','','No tag (now tagged TBD). Ewe from Charlies Farm. Multi color'],
    ['Pen 6','5','OAV 2222','oav-2222','2222','ewe','140','Katahdin','100','0','','hair','','','','Kelsiers sister. 100% Katahdin confirmed by Rocky and OAV 22'],
    ['Pen 1','6','Merrie','merrie','00016','ram','200','Cracker/St Augustine/Katahdin/BBB/White Dorper','50.0','50','hair','hair','smore','half-tail','','Flock spreadsheet: Tag 016, ram. SMore (100%Cr) x Half Tail '],
    ...
    ['Pen 1','6','Nori','nori','0029','ewe','139','ABB/Wiltshire Horn','100','0','','hair','','','','Nori breeding page: 50%ABB/50%WH, tag 21 (tag lost). Ewe wei'],
    ['Pen 2','7','Charlie','charlie-ram','','ram','232.2','Katahdin/BHD/ABB/Wiltshire Horn','100.0','0','','hair','','','','No tag (now tagged, number TBD). Charlies Ram. Horned. Had j'],
    ...
    ['Goose Pen','outside','0033 Twin Ram 1 (White/Brown)','tag-0033-twin-ram-1','','ram','','[UNCLEAR - 0033 offspring]','','','','','','tag-0033-hair-ewe','','No tag (now tagged, number TBD). Born ~1-1-26. Twin from 003'],
    ['Goose Pen','outside','0033 Twin Ram 2 (Black)','tag-0033-twin-ram-2','','ram','','[UNCLEAR - 0033 offspring]','','','','','','tag-0033-hair-ewe','','No tag (now tagged, number TBD). Born ~1-1-26. Twin from 003'],
    ...
    ['Goose Pen','outside','Charlies Ewe Ram Lamb','charlies-ram-lamb','','ram','','[UNCLEAR]','','','','','','charlies-ewe','','No tag (now tagged, number TBD). Born 12-26-25. 9.5 weeks ol'],
    ...
    ['Goose Pen','outside','FM2 Ram Lamb','fm2-ram-lamb','','ram','','[Kelsier x FM2 offspring]','','','','','kelsier','fm2-0051','','Born 1-31-26. FM2s baby ram. Sire: Kelsier. 2.6 weeks old as'],
    ...
    ['Goose Pen','outside','Orange 31 Ram Lamb','tag-31-orange-tf-ram-lamb','','ram','','','','','','','','tag-31-orange-tf','','Born 1-2-26. Orange tag 31 ewes baby ram. 7 weeks old 2-20-2'],
...
function updateDeceasedSold(ss) {
  ...
  var data = [
    ...
    ['Sam','sam','','ram','deceased','2026-04-02','Gulf Coast Native','','','Ram for pen 3 group. 100% Gulf Coast Native per Merrie breed'],
    ...
    ['Charlies Lamb','charlies-lamb-0017','0017','ram','deceased','2026-04-02','','charlies-ram','','Charlies rams lamb. Tag 0017. Marked deceased April 2026 — n'],
    ...
    ['Baby Momma','baby-momma','','ewe','deceased','2026-04-02','','','','In pen 3 (Sam group). Marked deceased April 2026 — not on no'],
    ['Zara','zara','025','ewe','deceased','','Dorper','','','Tag 25. Zara = Dorper 25 (same animal). 100% Dorper. Decease'],
    ['Half Tail','half-tail','','ewe','deceased','2026-04-02','St Augustine/Katahdin/BBB','sir-loin','hersheys','Flock spreadsheet: 12.5% BBB / 31.25% Katahdin / 56.25% St A'],
    ...
    ['S1','s1','','ewe','deceased','2026-04-02','','','','In pen 6 (no ram). Marked deceased April 2026 — not on noteb'],
    ['S2','s2','','ewe','deceased','2026-04-02','','','','In pen 2 (sirloin group). Marked deceased April 2026 — not o'],
    ...
    ['Patches','patches','27','ewe','deceased','2026-04-02','','','','Weight calculator: 65.6lbs (girth 27, length 27). Tag 27 — c'],
    ...
    ['New Big Girl 2','new-big-girl-2','','ewe','deceased','2026-04-02','','','','In pen 3 (Sam group). Marked deceased April 2026 — not on no'],
    ...
    ['FMs Lamb (2023)','fm-lamb-2023','','ewe','deceased','2026-04-02','St Augustine/Cotswold/Tunis/Katahdin','sir-loin','fm','FM × Sir Loin lamb = FM1 (tag 009). Born 4/1/2023. Birth wei'],
    ...
    ['GGs Daughter','gg-daughter-45','045','ewe','deceased','','','gg','','GGs daughter (GG is sire). Tag 45. Deceased.'],
    ['Laras Daughter','lara-daughter-46','046','ewe','sold','','','gg','lara','GG (sire) x Lara (dam) daughter. Tag 46. Sold because prone '],
    ['GGs Son','gg-son-094','094','ram','deceased','','','gg','','GGs son. Tag 094. Deceased.'],
    ...
    ['Dodge','dodge','','ram','sold','','Sir Loin x Broken Tail offspring','sir-loin','broken-tail','Sold off farm. Buyers named him Dodge. Sire of Little Daisy.'],
    ['Daisy','daisy','','ewe','sold','','Sir Loin x Anna offspring','sir-loin','anna','Sold off farm. Buyers named her Daisy. Dam of Little Daisy.'],
    ['Elsie Black Ram Triplet','elsie-triplet-black-ram','','ram','gifted','2026-03-15','','eclipse','elsie','Born 1-6-26. Elsies triplet. Black ram. Sire: Eclipse. Gifte'],
