...
function updatePipelineOverview(ss) {
  ...
  var data = [
    ...
    ['5','Pen 6','medium','NE corner, east side','Serendipity White Ram Twin','?','?','?','2','<2','<250','>80%','standard','Serendipity White Ram Twin (KelsierxSerendipity, ~56% Kat). PROVISIONAL  -  pend'],
...
function updateActiveFlock(ss) {
  ...
  var data = [
    ...
    ['Pen 3','1','Ewe Tag 02','tag-02-ewe-p5','02','ewe','','[UNCLEAR]','','','','','','','','Tag 02. Ewe. Pen 5. No babies. Proven breeder  -  Eclipse fa'],
