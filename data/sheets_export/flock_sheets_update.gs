...
function updateActiveFlock(ss) {
  ...
  var data = [
    ...
    ['Pen 3','1','Azure','azure','20','ewe','212.5','Hampshire/Suffolk','0','100','','wool','None','None','YES','Mom calls her Amure. GGs full sister. On weak resistance '],
    ...
    ['Pen 3','1','GG','gg','23','ewe','212.5','Hampshire/Suffolk','0','100','','wool','None','None','YES','Azures full brother. On weak resistance list. From Google S'],
    ...
    ['Pen 4','3','Rocky','rocky','140','ram','300','Black Headed Dorper/Awassi/East Friesian','50','50','','mixed','teaser','dorper-ewe-198','YES','Also called Jerkface/Rock/Louises Ram. Tag 140. 44%Awassi/5'],
    ...
    ['Pen 6','5','OAV 2222','oav-2222','2222','ewe','140','Katahdin','100','0','','hair','None','None','','Kelsiers sister. 100% Katahdin confirmed by Rocky and OAV 2'],
...
function updateBreedingPolicy(ss) {
  ...
  var data = [
    ...
    ['Hard Lesson','','Buying outside genetics is HIGH RISK. Even resistant breeds die here. Safest investment is whats already proven on th'],
    ['','',''],
...
function updateDeceasedSold(ss) {
  ...
  var data = [
    ...
    ['SMore','smore','22','ram','deceased','None','Cracker','None','None','Flock spreadsheet: Tag 22, 100% Cracker, 200lbs. Sire: Gigan'],
    ...
    ['Charlies Ram','charlies-ram','012','ram','deceased','2026-04-02','','None','None','Photos from March 18, 2024. Also called Mc11 or tag 12. Whit'],
    ['Pippin','pippin','015','ram','sold','None','Cracker/St Augustine/Katahdin','smore','bsoed','Pippin/BSOE1. Tag 015. SMore (100%Cr) x BSOED (40.5K/59.5SA'],
    ...
    ['Charlies Lamb','charlies-lamb-0017','0017','ram','deceased','2026-04-02','','charlies-ram','None','Charlies rams lamb. Tag 0017. Marked deceased April 2026 —'],
    ...
    ['Serendipitys Ram (2024)','serendipity-ram-2024','None','ram','deceased','2026-04-02','Hampshire/St Augustine/Babydoll/Jacob/Katahdin','samson','serendipity','Serendipitys 2024 ram lamb by Samson (100% Hampshire). Bree'],
    ...
    ['Little Daisys Baby (Mc01)','little-daisys-baby-mc01','None','ewe','deceased','2026-04-02','','None','little-daisy','Mc01. Called babys baby in notebook. Little Daisy #35s o'],
    ...
    ['Fox Tail','fox-tail','017','ewe','deceased','None','Cracker/St Augustine/Katahdin/Dorper','smore','trouble','Tag 17. SMore (100%Cr) x Trouble (37.5K/37.5SA/25Dorper). 5'],
    ...
    ['Half Tails Baby','half-tails-baby','007','ewe','deceased','2026-04-02','','None','half-tail','Tag 007. Half Tails baby. From measurement list. Marked dec'],
    ['Sb1 (Crown)','sb1-crown','002','ewe','deceased','2026-04-02','','None','None','Tag 002. Called Sb1 (crown) in measurements. Weight calcul'],
    ['Sb2 (All Black)','sb2-all-black','003','ewe','deceased','2026-04-02','','None','None','Tag 003. Called Sb2 (all black) in measurements. Weight ca'],
    ...
    ['Daisys Daughter 2','daisys-daughter-2','None','ewe','deceased','2026-04-02','St Augustine/Katahdin/BBB/Wiltshire','None','daisy','From Google Sheet Pen 5 and 6. In NoriSons group. Different'],
    ...
    ['Irish','irish','None','ewe','deceased','2026-04-02','','None','little-daisy','Little Daisys daughter. Needed parasite treatment April 13,'],
    ...
    ['FMs Lamb (2023)','fm-lamb-2023','None','ewe','deceased','2026-04-02','St Augustine/Cotswold/Tunis/Katahdin','sir-loin','fm','FM × Sir Loin lamb = FM1 (tag 009). Born 4/1/2023. Birth wei'],
    ...
    ['GGs Daughter','gg-daughter-45','045','ewe','deceased','None','','gg','None','GGs daughter (GG is sire). Tag 45. Deceased.'],
    ['Laras Daughter','lara-daughter-46','046','ewe','sold','None','','gg','lara','GG (sire) x Lara (dam) daughter. Tag 46. Sold because prone '],
    ['GGs Son','gg-son-094','094','ram','deceased','None','','gg','None','GGs son. Tag 094. Deceased.'],
    ...
    ['Kelsiers Sister','kelsiers-sister','2241','ewe','deceased','None','Katahdin','None','None','Kelsiers sister. Tag 2241. 100% Katahdin. Weight 150lbs. Br'],
    ...
    ['Annas Big One','annas-big-one','None','ewe','deceased','2026-04-02','Katahdin/St Augustine','sir-loin','anna','Flock spreadsheet: 62.5% Katahdin / 37.5% St Augustine, 200l'],
