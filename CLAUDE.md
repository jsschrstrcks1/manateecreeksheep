...
## Pen Structure (as of 2026-05-14)
...
| Pen 2 | Rocky (Jerkface, tag 140) | Little Daisy | — | 2 | Pen 2 contents owner-confirmed 2026-05-14: Rocky + Little Daisy only. (Little Daisy moved from Pen 4 on 2026-05-14. 0053 — no proper name; ) Planned: Rocky → Tree Fort. |
...
| Tree Fort (= Chicken Coop) | Buck | White Ewe 0035 (bred here, no name), Bambii (orange #35, from Heather Oaks Farm), Ewe 24/0003 (Sir Loin daughter, no name) | — | 4 | Same physical pen — prior records split into two rows; merged 2026-05-14. Lambs (0035 Baby Ram, Orange 31 Ram Lamb, Bambii's Baby) weaned to Goose Pen 2026-05-14. **Membership corrections 2026-05-14:** Orange Tag 31 Ewe removed (no longer in Tree Fort, location unknown); Bambii's tag corrected to orange #35 (prior "24/0003" was a transcription error); Ewe 24/0003 added (the actual holder of that scrapie tag — Sir Loin daughter, white w/ wool on back). **Planned: Buck → Pen 6; Rocky (Pen 2) → Tree Fort.** |

**Total active flock: ~55 animals** — 54 across 8 pens + 1 unlocated (Orange Tag 31 Ewe, alive but pen unknown as of 2026-05-14 owner check). Compared with prior snapshot: +1 new Tree Fort ewe (Ewe 24/0003 — Sir Loin daughter, surfaced 2026-05-14); Orange Tag 31 Ewe still alive but no longer in Tree Fort, current pen TBD.
